...
button_save.addEventListener('click', event => {
    ...
    let xmlTitle = `<?xml version="1.0"?>\n<font>\n`;
    let str = xmlTitle + `<info face=\"Arial\" size=\"${fontSize}\" bold=\"0\" italic=\"0\" charset=\"\" unicode=\"1\" stretchH=\"100\" smooth=\"1\" aa=\"1\" padding=\"0,0,0,0\" spacing=\"1,1\" outline=\"0\"/>\n<common lineHeight=\"${fontSize}\" base=\"26\" scaleW=\"${canvasWidth}\" scaleH=\"${canvasHeight}\" pages=\"1\" packed=\"0\" alphaChnl=\"1\" redChnl=\"0\" greenChnl=\"0\" blueChnl=\"0\"/>\n<pages>\n<page id=\"0\" file="${fontName}.png"/>\n</pages>\n<chars count=\"${imageList.length}\">\n`;
    imageList.forEach(img => {
        str += `<char id=\"${img.char.charCodeAt(0)}\" x=\"${img.x}\" y=\"${img.y}\" width=\"${img.width}\" height=\"${img.height}\" xoffset=\"${img.xoffset}\" yoffset=\"${img.yoffset}\" xadvance=\"${img.xadvance}\" page=\"0\" chnl=\"15\"/>\n`
    })
    str += '</chars>\n</font>\n';
